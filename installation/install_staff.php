...
//tb 1
$tb = 'zpm_staffs';
$sql = "CREATE TABLE $tb (id int(5) auto_increment, level int(1), lockr int(1), randkey varchar(100), username varchar(15), password varchar(25), question_1 varchar(55), question_2 varchar(55), question_3 varchar(55), answer_1 varchar(55), answer_2 varchar(55), answer_3 varchar(55), token_1 varchar(55), name varchar(30), email varchar(45), phone varchar(14), address varchar(140), sex varchar(10), dateOfReg varchar(70), lastLogin varchar(55), nowLogin varchar(55), other varchar(500),  primary key(id))";
