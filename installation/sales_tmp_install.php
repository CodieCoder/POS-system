...
//tb 1
	$tb = 'zpm_tmp_sales';
	$sql = "CREATE TABLE $tb (id int(5) auto_increment, blockr varchar(55), block_name varchar(55), block_phone varchar(55), product varchar(30), category varchar(33), randkey varchar(100), user_add varchar(33), price varchar(10), qty int(10), date varchar(35), time varchar(25), other varchar(120), primary key(id))";
