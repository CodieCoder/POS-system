				...
				// print_r($getter);
					...
					//converting it to json
						...
						// echo $output;
							...
							$myjson = array("1" => "$result", "2" => "$output", "3" => "$username");
		...
		<div id = "app_body">
			<div id = "login_form">
				<form name = "z_staff_login" method = "POST" action = "index4.php">
					...
					<div id = "login_form_error_note" style = "display:none">
						<?php $auError; ?>
					</div>
					...
					//check length
						...
						else
						{
							...
							.done(function(data)
							{
								...
								if(data_result == "yes")
								{
									window.location = "dashboard.php?idkey=" + data_output + "&&user=" + data_uname + "&&get=" + data_result;
